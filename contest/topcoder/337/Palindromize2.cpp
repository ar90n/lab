...
{
    {
        ...
        Palindromize2 theObject;
        eq(0, theObject.minChanges(s), expected);
    }
    {
        string s = "cigartragic";
        string expected = "cigartragic";
        Palindromize2 theObject;
        eq(1, theObject.minChanges(s), expected);
    }
    {
        string s = "abcdef";
        string expected = "abccba";
        Palindromize2 theObject;
        eq(2, theObject.minChanges(s), expected);
    }
    {
        string s = "cxbpaxz";
        string expected = "cxapaxc";
        Palindromize2 theObject;
        eq(3, theObject.minChanges(s), expected);
    }
