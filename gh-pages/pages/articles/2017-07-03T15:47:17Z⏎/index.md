---
title: HourRank22参戦
date: "2017-07-03T15:47:17Z"
layout: post
path: "/blog/2017-07-03T15:47:17Z/"
category:
- "競技プログラミング"
description: "HourRank22に参加．レーティングは1876->1802"
---
Easyしか解けなかったため，レーティングか1876から1802に下がってしまった．

### Parity Game
与えられた数列の和の奇偶に応じて0か1かを返す．
数列超が１の場合は-1を返すことに気をつける.
``` fsharp
#!/usr/bin/env fsharpi
...
### Super Mancunian
MSTを作成して最大コスト辺にスパーパワーを使うあたりまでは思いついたが，スーパーパワーを使用しうる辺の数の求め方はわからなかった．   
以下は、エディトリアルをみながら実装したもの．
``` fsharp
#!/usr/bin/env fsharpi
