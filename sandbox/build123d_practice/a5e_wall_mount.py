...
import numpy as np
# %%
board_hole_hor_far_interval = 52.3
board_hole_hor_near_interval = 45.1
board_hole_ver_far_interval = 61.0
board_hole_ver_near_interval = 54.1
board_hole_hor_interval = (board_hole_hor_far_interval + board_hole_hor_near_interval) / 2.0
board_hole_ver_interval = (board_hole_ver_far_interval + board_hole_ver_near_interval) / 2.0
board_hole_hor_rad = (board_hole_hor_far_interval - board_hole_hor_near_interval) / 4.0
board_hole_ver_rad = (board_hole_ver_far_interval - board_hole_ver_near_interval) / 4.0
board_hole_rad = ((board_hole_hor_rad + board_hole_ver_rad) / 2.0) * 0.95
board_hole_depth = 1.4
board_edge_rad = 3.0

wall_pillar_diameter = 5.4
wall_pillar_length = 5.1
wall_ver_far_interval = 54.1
wall_ver_near_interval = 44.0
wall_hole_interval = (wall_ver_far_interval + wall_ver_near_interval) / 2.0

mount_thickness = 3.0
# %%
board_hole_locs = np.array([
    (-board_hole_hor_interval / 2.0, -board_hole_ver_interval / 2.0),
    (board_hole_hor_interval / 2.0, -board_hole_ver_interval / 2.0),
    (-board_hole_hor_interval / 2.0, board_hole_ver_interval / 2.0),
    (board_hole_hor_interval / 2.0, board_hole_ver_interval / 2.0),
])
wall_hole_locs = np.array([
    (-board_hole_hor_interval / 2.0, -board_hole_ver_interval / 2.0),
    (board_hole_hor_interval / 2.0, -board_hole_ver_interval / 2.0 ),
    (-board_hole_hor_interval / 2.0, -board_hole_ver_interval / 2.0 + wall_hole_interval),
    (board_hole_hor_interval / 2.0,  -board_hole_ver_interval / 2.0 + wall_hole_interval),
])
board_hole_inner_locs = 0.5 * board_hole_locs
# %%
with BuildPart() as board_pillar:
n    l = 10
    spacer = Cylinder(board_hole_rad* 1.4, l, align=[Align.CENTER, Align.CENTER, Align.MAX])
    pillar = Cylinder(board_hole_rad* 0.90, board_hole_depth + l, align=[Align.CENTER, Align.CENTER, Align.MAX])
...
with BuildPart() as board_wall_mount:
    with BuildSketch():
        with BuildLine():
            Spline([
                board_hole_locs[0],
                board_hole_inner_locs[0],
                board_hole_inner_locs[1],
                board_hole_locs[1],
            ])
            Spline([
                board_hole_inner_locs[0],
                board_hole_inner_locs[2],
            ])
            Spline([
                board_hole_inner_locs[1],
                board_hole_inner_locs[3],
            ])
            Spline([
                board_hole_locs[2],
                wall_hole_locs[2],
        ...
        for loc in [*board_hole_locs, wall_hole_locs[2], wall_hole_locs[3]]:
...
# %%
export_stl(board_wall_mount.part, "a5e_wall_mount.stl")
# %%
