...
board_hole_ver_far_interval = 81.0
board_hole_ver_near_interval = 74.2
...
wall_ver_far_interval = 80.0
wall_ver_near_interval = 69.8
...
# %%
export_stl(board_wall_mount.part, "canmv_wall_mount.stl")
# %%
