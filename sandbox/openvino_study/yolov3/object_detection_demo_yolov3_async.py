...
def build_argparser():
    ...
    args.add_argument("input", type=str, nargs="+", help="Paths to input image")
    return parser
...
def main():
    ...
    for p in args.input:
        ...
        async_mode_message = "Async mode is off. Processing request {}".format(request_id)
        parsing_message = "YOLO parsing time is {:.3f}".format(parsing_time * 1e3)
        print(inf_time_message)
        print(async_mode_message)
