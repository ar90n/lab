...
int gradient(struct halide_buffer_t *_gradient_buffer) HALIDE_FUNCTION_ATTRS {
 uint64_t _0 = reinterpret<uint64_t>(_gradient_buffer);
 uint64_t _1 = (uint64_t)(0);
 bool _2 = _0 != _1;
 if (!_2)  {
  int32_t _3 = halide_error_buffer_argument_is_null(nullptr, "gradient");
  return _3;
 }
 void *_4 = _halide_buffer_get_host(_gradient_buffer);
 void * _gradient = _4;
 uint8_t _5 = _halide_buffer_get_type_code(_gradient_buffer);
 uint8_t _6 = _halide_buffer_get_type_bits(_gradient_buffer);
 uint16_t _7 = _halide_buffer_get_type_lanes(_gradient_buffer);
 int32_t _8 = _halide_buffer_get_min(_gradient_buffer, 0);
 int32_t _9 = _halide_buffer_get_extent(_gradient_buffer, 0);
 int32_t _10 = _halide_buffer_get_stride(_gradient_buffer, 0);
 int32_t _11 = _halide_buffer_get_min(_gradient_buffer, 1);
 int32_t _12 = _halide_buffer_get_extent(_gradient_buffer, 1);
 int32_t _13 = _halide_buffer_get_stride(_gradient_buffer, 1);
 bool _14 = _halide_buffer_is_bounds_query(_gradient_buffer);
 if (_14)
 {
  struct halide_dimension_t *_15 = _halide_buffer_get_shape(_gradient_buffer);
  uint64_t _16 = (uint64_t)(0);
  void *_17 = (void *)(_16);
  struct halide_device_interface_t *_18 = (struct halide_device_interface_t *)(_16);
  struct {const int32_t f_0; const int32_t f_1; const int32_t f_2; const int32_t f_3; const int32_t f_4; const int32_t f_5; const int32_t f_6; const int32_t f_7; }  s0 = {_8, _9, 1, 0, _11, _12, _9, 0};
  struct halide_dimension_t *_19 = (struct halide_dimension_t *)(&s0);
  struct halide_buffer_t *_20 = _halide_buffer_init(_gradient_buffer, _15, _17, _16, _18, 0, 32, 2, _19, _16);
  (void)_20;
 } // if _14
 bool _21 = _halide_buffer_is_bounds_query(_gradient_buffer);
 bool _22 = !(_21);
 if (_22)
 {
  uint8_t _23 = (uint8_t)(0);
  bool _24 = _5 == _23;
  uint8_t _25 = (uint8_t)(32);
  bool _26 = _6 == _25;
  bool _27 = _24 && _26;
  uint16_t _28 = (uint16_t)(1);
  bool _29 = _7 == _28;
  bool _30 = _27 && _29;
  if (!_30)   {
   uint8_t _31 = (uint8_t)(0);
   uint8_t _32 = (uint8_t)(32);
   uint16_t _33 = (uint16_t)(1);
   int32_t _34 = halide_error_bad_type(nullptr, "Output buffer gradient", _5, _31, _6, _32, _7, _33);
   return _34;
  }
  bool _35 = 0 <= _9;
  if (!_35)   {
   int32_t _36 = halide_error_buffer_extents_negative(nullptr, "Output buffer gradient", 0, _9);
   return _36;
  }
  bool _37 = 0 <= _12;
  if (!_37)   {
   int32_t _38 = halide_error_buffer_extents_negative(nullptr, "Output buffer gradient", 1, _12);
   return _38;
  }
  bool _39 = _10 == 1;
  if (!_39)   {
   int32_t _40 = halide_error_constraint_violated(nullptr, "gradient.stride.0", _10, "1", 1);
   return _40;
  }
  int64_t _41 = (int64_t)(_12);
  int64_t _42 = (int64_t)(_9);
  int64_t _43 = _41 * _42;
  int64_t _44 = (int64_t)(0);
  int64_t _45 = _44 - _42;
  bool _46 = _42 > _44;
  int64_t _47 = (int64_t)(_46 ? _42 : _45);
  uint64_t _48 = (uint64_t)(_47);
  uint64_t _49 = _48;
  uint64_t _50 = (uint64_t)(2147483647);
  bool _51 = _49 <= _50;
  if (!_51)   {
   int64_t _52 = (int64_t)(_9);
   int64_t _53 = (int64_t)(0);
   int64_t _54 = _53 - _52;
   bool _55 = _52 > _53;
   int64_t _56 = (int64_t)(_55 ? _52 : _54);
   uint64_t _57 = (uint64_t)(_56);
   uint64_t _58 = _57;
   uint64_t _59 = (uint64_t)(2147483647);
   int32_t _60 = halide_error_buffer_allocation_too_large(nullptr, "gradient", _58, _59);
   return _60;
  }
  int64_t _61 = (int64_t)(_12);
  int64_t _62 = (int64_t)(_13);
  int64_t _63 = _61 * _62;
  int64_t _64 = (int64_t)(0);
  int64_t _65 = _64 - _63;
  bool _66 = _63 > _64;
  int64_t _67 = (int64_t)(_66 ? _63 : _65);
  uint64_t _68 = (uint64_t)(_67);
  uint64_t _69 = _68;
  uint64_t _70 = (uint64_t)(2147483647);
  bool _71 = _69 <= _70;
  if (!_71)   {
   int64_t _72 = (int64_t)(_12);
   int64_t _73 = (int64_t)(_13);
   int64_t _74 = _72 * _73;
   int64_t _75 = (int64_t)(0);
   int64_t _76 = _75 - _74;
   bool _77 = _74 > _75;
   int64_t _78 = (int64_t)(_77 ? _74 : _76);
   uint64_t _79 = (uint64_t)(_78);
   uint64_t _80 = _79;
   uint64_t _81 = (uint64_t)(2147483647);
   int32_t _82 = halide_error_buffer_allocation_too_large(nullptr, "gradient", _80, _81);
   return _82;
  }
  int64_t _83 = (int64_t)(2147483647);
  bool _84 = _43 <= _83;
  if (!_84)   {
   int64_t _85 = (int64_t)(2147483647);
   int32_t _86 = halide_error_buffer_extents_too_large(nullptr, "gradient", _43, _85);
   return _86;
  }
  // produce gradient
  for (int _gradient_s0_y = _11; _gradient_s0_y < _11 + _12; _gradient_s0_y++)
  {
   for (int _gradient_s0_x = _8; _gradient_s0_x < _8 + _9; _gradient_s0_x++)
   {
    int32_t _87 = _gradient_s0_y * _13;
    int32_t _88 = _gradient_s0_x + _87;
    int32_t _89 = _11 * _13;
    int32_t _90 = _8 + _89;
    int32_t _91 = _88 - _90;
    int32_t _92 = _gradient_s0_x + _gradient_s0_y;
    ((int32_t *)_gradient)[_91] = _92;
   } // for _gradient_s0_x
  } // for _gradient_s0_y
 } // if _22
 return 0;
...
int gradient_old_buffer_t(struct buffer_t *_gradient) HALIDE_FUNCTION_ATTRS {
 struct {const int32_t f_0; const int32_t f_1; const int32_t f_2; const int32_t f_3; const int32_t f_4; const int32_t f_5; const int32_t f_6; const int32_t f_7; }  s1 = {0, 0, 0, 0, 0, 0, 0, 0};
 struct halide_dimension_t *_93 = (struct halide_dimension_t *)(&s1);
 struct halide_dimension_t * _t34 = _93;
 halide_buffer_t b2;
 struct halide_buffer_t *_94 = &b2;
 uint64_t _95 = (uint64_t)(0);
 void *_96 = (void *)(_95);
 struct halide_device_interface_t *_97 = (struct halide_device_interface_t *)(_95);
 struct halide_buffer_t *_98 = _halide_buffer_init(_94, _t34, _96, _95, _97, 0, 32, 2, _t34, _95);
 struct halide_buffer_t * _gradient_upgraded = _98;
 int32_t _99 = halide_upgrade_buffer_t(nullptr, "gradient", _gradient, _gradient_upgraded);
 bool _100 = _99 == 0;
 if (!_100)  {
  return _99;
 }
 int32_t _101 = gradient(_gradient_upgraded);
 bool _102 = _101 == 0;
 if (!_102)  {
  return _101;
 }
 bool _103 = _halide_buffer_is_bounds_query(_gradient_upgraded);
 if (_103)
 {
  int32_t _104 = halide_downgrade_buffer_t(nullptr, "gradient", _gradient_upgraded, _gradient);
  bool _105 = _104 == 0;
  if (!_105)   {
   return _104;
  }
 ...
 {
  int32_t _106 = halide_downgrade_buffer_t_device_fields(nullptr, "gradient", _gradient_upgraded, _gradient);
  bool _107 = _106 == 0;
  if (!_107)   {
   return _106;
  }
